	...
	<div class="wrapper">
		<div class="page-header section-dark" style="background-image: url('${root}/resources/img/counselling1.jpg')">
			<div class="content-center col-md-8" style="background-color: #ffffffc4; height: 1000px">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="col-name row">
								<div class="col-md-4 colName"><h4 style="margin:10 0; text-align:center;">현지권</h4></div>
							...
							<div class="col-md-4"><h6 style="color:red; margin-top:10;">예비 상담사</h6></div>
								<div class="col-md-12">
									<p>헬로마인드 예비상담사 현지권입니다. 임상심리 상담경력 30회 이상 보유하고 있습니다. </p>
								</div>
						</div>
					</div><br/>
				...
				<div class="row">
						<div class="col-md-3" style="margin-top:20px;">
							<img src="${root}/resources/img/upload/pic/pic_2.png" alt="Circle Image" 
							class="img-no-padding img-responsive img-col">
						</div>	
						<div class="col-md-9">
							<div class="col-name row">
					...
					<div class="row">
						<div class="col-md-3" style="margin-top:20px;">
							<img src="${root}/resources/img/upload/pic/pic_3.png" alt="Circle Image" 
							class="img-no-padding img-responsive img-col">
						</div>	
						<div class="col-md-9">
							<div class="col-name row">
					...
					<div class="row">
						<div class="col-md-3" style="margin-top:20px;">
							<img src="${root}/resources/img/upload/pic/pic_1.png" alt="Circle Image" 
							class="img-no-padding img-responsive img-col">
						</div>	
						<div class="col-md-9">
							<div class="col-name row">
